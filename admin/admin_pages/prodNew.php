...
if ($_POST) {
	...
	$stmt = $conn->prepare("INSERT INTO products (name, description, price, priceDiscount, fk_brand, fk_img, fk_created)
													VALUES (?, ?, ?, ?, ?, ?, ?)");
	$stmt->bind_param('ssdiiii', $_POST['productTitle'],
